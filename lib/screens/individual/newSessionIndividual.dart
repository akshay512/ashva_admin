...
class NewSessionIndividual extends StatefulWidget {
  @override
  _NewSessionIndividualState createState() => _NewSessionIndividualState();
}

class _NewSessionIndividualState extends State<NewSessionIndividual> {
