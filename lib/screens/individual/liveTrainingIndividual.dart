...
class LiveTrainingIndividual extends StatefulWidget {
  @override
  _LiveTrainingIndividualState createState() => _LiveTrainingIndividualState();
}

class _LiveTrainingIndividualState extends State<LiveTrainingIndividual> {
