...
class AddWorkoutTemplateIndividual extends StatefulWidget {
  AddWorkoutTemplateIndividual({Key key}) : super(key: key);

  @override
  _AddWorkoutTemplateIndividualState createState() =>
      _AddWorkoutTemplateIndividualState();
}

class _AddWorkoutTemplateIndividualState
    extends State<AddWorkoutTemplateIndividual> {
