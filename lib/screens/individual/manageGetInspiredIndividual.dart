...
class GetInspiredPageIndividual extends StatefulWidget {
  GetInspiredPageIndividual({Key key}) : super(key: key);

  @override
  _GetInspiredPageIndividualState createState() =>
      _GetInspiredPageIndividualState();
}

class _GetInspiredPageIndividualState extends State<GetInspiredPageIndividual> {
